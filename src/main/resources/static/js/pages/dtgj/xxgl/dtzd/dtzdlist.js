...
layui.config({
    ...
    function loadDataData() {
        table.render({
            ...
            cols: [[
                ...
                { field: 'DTXLBM', title: '线路编码', width: '15%' },
    ...
    function showEdit(varType, varId) {
        var tmpTitle = '详情信息';
        var tmpUrl = '/dtgj/xxgl/dtzd/edit?type=' + varType + '&menuid=' + $.getUrlParam("id") + '&id=' + varId + '&xlbm=' + mXlbm;
    ...
    function setIsDelByBm(varId, varBm) {
        ...
        $.ajax({
            type: 'get',
            url: '/api/dtgj/xxgl/dtzd/getisdelbybm',
            headers: { token: localStorage["token"] },
            data: { bm: varBm },
            dataType: 'json',
            success: function (data) {
