        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.code == "1") {
                    ...
                    $('#yj_zdry_zprlzp').val(item.ZDRY_ZPRLZP);
                    $('#yj_zdry_bkrlzp').val(item.ZDRY_BKRLZP);
    ...
    function loadZdryData(varSfzh) {
        ...
        $.ajax({
            ...
            success: function (data) {
                layer.close(index);
                if (data.code == "1") {
                    var item = data.data; $('#zd_xzqhdm').val(item.XZQHDM);
                    $('#zd_zdry_gmsfhm').val(item.ZDRY_GMSFHM);
                    $('#zd_zdry_xm').val(item.ZDRY_XM);
                    $('#zd_zdry_zzmmdm').val(item.ZDRY_ZZMMDM);
                    $('#zd_zdry_zy').val(item.ZDRY_ZY);
                    $('#zd_zdry_xbdm').val(item.ZDRY_XBDM);
                    $('#zd_zdry_csrq').val(item.ZDRY_CSRQ);
                    $('#zd_zdry_xldm').val(item.ZDRY_XLDM);
                    $('#zd_zdry_mzdm').val(item.ZDRY_MZDM);
                    $('#zd_zdry_dzmc').val(item.ZDRY_DZMC);
                    $('#zd_zdry_zdrflbm').val(item.ZDRY_ZDRFLBM);
                    $('#zd_zdry_zp').val(item.ZDRY_ZP);
