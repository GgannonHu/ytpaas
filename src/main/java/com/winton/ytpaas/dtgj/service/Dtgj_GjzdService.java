...
import com.winton.ytpaas.dtgj.dao.Dtgj_GjzdDao;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

@Service("dtgjGjzdService")
public class Dtgj_GjzdService {
    @Autowired
    Dtgj_GjzdDao dao;
    ...
    public Result add(Map<String, Object> varItem) {
        Result res = new Result();
        int tmpCon = dao.getConByZdbm(varItem.get("gjzdbm"));
        if (tmpCon == 0) {
