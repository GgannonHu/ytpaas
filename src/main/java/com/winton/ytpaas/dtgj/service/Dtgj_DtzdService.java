...
import com.winton.ytpaas.dtgj.dao.Dtgj_DtzdDao;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

@Service("dtgjDtzdService")
public class Dtgj_DtzdService {
    @Autowired
    Dtgj_DtzdDao dao;
    ...
    public Result add(Map<String, Object> varItem) {
        Result res = new Result();
        int tmpCon = dao.getConByZdbm(varItem.get("dtzdbm"));
        if (tmpCon == 0) {
