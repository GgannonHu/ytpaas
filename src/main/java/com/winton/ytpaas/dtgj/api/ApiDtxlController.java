...
import com.winton.ytpaas.dtgj.service.Dtgj_DtxlService;
...
@RestController
@RequestMapping("/api/dtgj/xxgl/dtxl")
@Api(value = "地铁公交_地铁线路", description = "地铁公交_地铁线路")
public class ApiDtxlController {

    @Autowired
    Dtgj_DtxlService service;
    @Autowired
    ...
    @ApiOperation(value = "添加地铁线路", notes = "添加地铁线路", httpMethod = "POST")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "token", value = "用户的token令牌", dataType = "String", paramType = "header", required = true) })
    @RequestMapping(value = "/add", produces = "application/json")
    @SystemLog(description = "地铁公交_添加地铁线路", type = LogType.API)
    public String add(HttpServletRequest request, HttpServletResponse response) throws ParseException {
        ...
        tmpItem.put("dtxlbh", request.getParameter("dtxlbh"));
        tmpItem.put("dtxlmc", request.getParameter("dtxlmc"));
        tmpItem.put("dtxlqdz", request.getParameter("dtxlqdz"));
        tmpItem.put("dtxlzdz", request.getParameter("dtxlzdz"));
        tmpItem.put("xllc", request.getParameter("xllc"));
    ...
    @ApiOperation(value = "修改地铁线路", notes = "修改地铁线路", httpMethod = "POST")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "", value = "", dataType = "String", paramType = "query", required = true),
            @ApiImplicitParam(name = "token", value = "用户的token令牌", dataType = "String", paramType = "header", required = true) })
    @RequestMapping(value = "/update", produces = "application/json")
    @SystemLog(description = "地铁公交_修改地铁线路", type = LogType.API)
    ...
    @ApiOperation(value = "删除地铁线路", notes = "删除地铁线路", httpMethod = "POST")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "ids", value = "需要删除的主键ID", dataType = "String", paramType = "query", required = true),
            @ApiImplicitParam(name = "token", value = "用户的token令牌", dataType = "String", paramType = "header", required = true) })
    @RequestMapping(value = "/delete", produces = "application/json")
    @SystemLog(description = "地铁公交_删除地铁线路", type = LogType.API)
